				...
				<form action='{{url(\Config::get('adminPrefix').'/settings/payment-methods/update-paymentMethod-Credentials')}}' class="form-horizontal" method="POST" id="currencyPaymentMethod_form">
					...
					<div class="box-body">
						...
						@elseif ($list_menu == 'paystack')
							<!-- paystack - Client ID -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="paystack[client_id]">Client ID</label>
								<div class="col-sm-5">
									<input class="form-control" name="paystack[client_id]" type="text" placeholder="Paystack Client ID"
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="paystack[client_secret]">Client Secret</label>
								<div class="col-sm-5">
									<input class="form-control" name="paystack[client_secret]" type="text" placeholder="Paystack Client Secret"
						...
						@elseif ($list_menu == 'flutterwave')
							<!-- flutterwave - Client ID -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="flutterwave[client_id]">Client ID</label>
								<div class="col-sm-5">
									<input class="form-control" name="flutterwave[client_id]" type="text" placeholder="Flutterwave Client ID"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->client_id : '' }}" id="flutterwave_client_id">

									@if ($errors->has('flutterwave[client_id]'))
									<span class="help-block">
										<strong>{{ $errors->first('flutterwave[client_id]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="flutterwave[client_secret]">Client Secret</label>
								<div class="col-sm-5">
									<input class="form-control" name="flutterwave[client_secret]" type="text" placeholder="Flutterwave Client Secret"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->client_secret : '' }}" id="flutterwave_client_secret">
									@if ($errors->has('flutterwave[client_secret]'))
									<span class="help-block">
										<strong>{{ $errors->first('flutterwave[client_secret]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="flutterwave[environment]">Environment</label>
								<div class="col-sm-5">
									<input class="form-control" name="flutterwave[environment]" type="text" placeholder="Flutterwave Environment"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->environment : 'staging' }}" id="flutterwave_client_secret">
									@if ($errors->has('flutterwave[environment]'))
									<span class="help-block">
										<strong>{{ $errors->first('flutterwave[environment]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="flutterwave[secret_hash]">Secret Hash</label>
								<div class="col-sm-5">
									<input class="form-control" name="flutterwave[secret_hash]" type="text" placeholder="Flutterwave  Secret Hash"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->secret_hash : '' }}" id="flutterwave_client_secret">
							...
							<!-- flutterwave - processing_time -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="processing_time">Processing Time (days)</label>
								<div class="col-sm-5">
									<input class="form-control" name="processing_time" type="text" placeholder="Flutterwave Processing Time"
									value="{{ isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : '' }}" id="processing_time">
							...
							<!-- flutterwave - Mode -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="flutterwave[mode]">Mode</label>
								<div class="col-sm-5">
									<select class="form-control" name="flutterwave[mode]" id="flutterwave_mode">
										<option value="">Select Mode</option>
										<option value='sandbox' {{ isset($currencyPaymentMethod->method_data) && (json_decode($currencyPaymentMethod->method_data)->mode) == 'sandbox' ? 'selected':"" }} >sandbox</option>
										<option value='live' {{ isset($currencyPaymentMethod->method_data) && (json_decode($currencyPaymentMethod->method_data)->mode) == 'live' ? 'selected':"" }} >live</option>
									</select>
							...
							<!-- flutterwave - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="flutterwave_status">Status</label>
								<div class="col-sm-5">
									<select class="form-control" name="flutterwave_status" id="flutterwave_status">
										<option value=''>Select Status</option>
