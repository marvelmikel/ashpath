...
<section class="min-vh-100">
    <div class="my-30">
        <div class="container-fluid">
            <!-- Page title start -->
            <div>
                <h3 class="page-title">{{ __('Create Escrow') }}</h3>
            </div>
            <!-- Page title end-->
            <div class="row mt-4">
                <div class="col-lg-4">
                    ...
                    <div class="mt-5">
                        ...
                        <p class="text-gray-500 text-16 text-justify"> {{ __('Enter your recipient\'s email address or phone number & then add an amount with currency to send money via escrow. The money will be held until transaction is confirmed by both parties. You can also provide a note for a reference.') }}</p>
                    </div>
                    <!-- Sub title end-->
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-10">
                            ...
                            <div class="bg-secondary rounded mt-5 shadow p-35">
                                ...
                                <form method="POST" action="{{ url('store-escrow') }}" id="transfer_form" accept-charset='UTF-8'>
