                            ...
                            <div class="bg-secondary rounded mt-5 shadow py-4 p-35">
                                ...
                                <div>
									...
									<div class="d-flex flex-wrap justify-content-between">
										...
										<div class="pl-2">
											<p class="font-weight-600">{{ moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['totalAmount'])) }}</p>
										</div>
									</div>
									...
									<div class="row m-0 mt-4 justify-content-between">
										...
										<div>
											<a href="{{url('store-escrow-confirm')}}" class="sendMoneyPaymentConfirmLink">
