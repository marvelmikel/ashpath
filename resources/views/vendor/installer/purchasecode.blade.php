  ...
  <div class="card">
            <div class="card-content black-text">
                    <div class="center-align">
                        ...
                        <p class="card-title"><?php echo str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>');?> </p>
                        <hr>
                    </div>
                     <form class="form-horizontal" action="{{url('install/verify-envato-purchase-code')}}" method="post">
                          ...
                          <div class="form-group">
                            <div class="col-md-8 offset-2">
                              ...
                              <input type="text" class="form-control" id="envatopurchasecode" name="envatopurchasecode" placeholder="{{trans('installer.welcome.envato_placeholder_text')}}" value="Nulled-By-NullJungle.com">
